...
import newBackground from "./images/new-background.webp";

function App() {
  return (
    <>
      <div className="fixed left-0 top-0 h-full w-full">
        <div className="absolute inset-0 -z-10 min-h-full w-full bg-cover bg-center" style={{ backgroundImage: `url(${newBackground})` }}></div>
